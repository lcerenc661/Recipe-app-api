...
class PrivateRecipeAPITests(TestCase):
    ...
    def test_get_recipe_detail(self):
        """Test get recipe detail view succesful."""
    ...
    def test_update_user_returns_error(self):
        ...
        new_user = create_user(email='userr@example.com', password='pass1223')
        recipe = create_recipe(user=self.user)
    ...
    def test_delete_recipe_others_users_recipe_error(self):
        """Test trying to delete another users recipe gives error"""
        new_user = create_user(
            email='newemail@example.com', password='testpass123')
    ...
    def test_create_recipe_with_new_tags(self):
        ...
        payload = {
            ...
            'time_minutes': 60,
            'price': Decimal('4.50'),
            'tags': [{'name': 'Indian'}, {'name': 'Brakfast'}]
        }
    ...
    def test_create_tag_on_update(self):
        ...
        recipe = create_recipe(user=self.user)
        payload = {'tags': [{'name': 'Mexican'}, {'name': 'Breakfast'}]}
    ...
    def test_update_recipe_assing_tag(self):
        ...
        payload = {'tags': [{'name': tag_breakfast.name}]}
    ...
    def test_create_recipe_with_new_ingredients(self):
        ...
        payload = {'title': 'New Recipe Test',
                   'time_minutes': 60,
                   'price': Decimal('4.50'),
                   'tags': [{'name': 'Indian'}, {'name': 'Brakfast'}],
                   'ingredients': [{'name': 'Indian'}, {'name': 'Brakfast'}]
                   }
    ...
    def test_create_recipe_with_existing_ingredient(self):
        ...
        ingredient = Ingredient.objects.create(name='Indian', user=self.user)
        payload = {
    ...
    def test_update_ingredient_on_update(self):
        ...
        self.assertEqual(res.status_code, status.HTTP_200_OK)
        new_ingredient = Ingredient.objects.get(name='Cocoa')
    ...
    def test_clearing_recipes_ingridients(self):
        """Test clearing recipes ingridients"""
        ingredient = Ingredient.objects.create(
            name='Tomato Sauce',
            user=self.user
        )
    ...
    def test_filter_by_ingredients(self):
        ...
        r3 = create_recipe(user=self.user, title='Guacamole')
